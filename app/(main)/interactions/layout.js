...
const Elementslayout = ({ children }) => {
  ...
  const navLinks = [
    { href: "/interactions/basic-details", label: "Basic Details Form" },
    { href: "/interactions/job-application", label: "Job Application Form" },
    { href: "/interactions/to-do", label: "TO DO List form" },
  ];
    ...
    <div className="container flex flex-col md:flex-row p-4 gap-3 md:gap-5">
      <div className="flex flex-col">
        <h1 className="text-6xl font-bold gradient-title mb-5">
          <Link href={"/interactions/basic-details"}>Interactions</Link>
        </h1>
