...
export async function generateMetadata({ params }) {
  ...
  const filePath = path.join(process.cwd(), "Blog/Alerts", `${slug}.md`);
  ...
  return {
    ...
    openGraph: {
      ...
      url: `${basicDetails.websiteURL}/alert-window/${slug}`,
      images: data.image ? [{ url: data.image }] : [],
    },
    alternates: {
      canonical: `${basicDetails.websiteURL}/alert-window/${slug}`,
    },
  };
}
