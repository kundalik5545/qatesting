...
export const buttonTC = [
  {
    TestId: "TC01",
    TestCaseName: "Verify that the button is clickable",
  },
  {
    TestId: "TC02",
    TestCaseName: "Verify that the button displays the correct label",
  },
  {
    TestId: "TC03",
    TestCaseName: "Verify that the button triggers the correct action on click",
  },
  {
    TestId: "TC04",
    TestCaseName: "Verify the button's appearance on hover",
  },
  {
    TestId: "TC05",
    TestCaseName: "Verify the button's appearance on focus",
  },
  {
    TestId: "TC06",
    TestCaseName: "Verify that the button is disabled when it should be",
  },
  {
    TestId: "TC07",
    TestCaseName: "Verify that the button is enabled when it should be",
  },
  {
    TestId: "TC08",
    TestCaseName:
      "Verify the button's responsiveness on different screen sizes",
  },
  {
    TestId: "TC09",
    TestCaseName:
      "Verify that the button is accessible via keyboard interactions",
  },
  {
    TestId: "TC10",
    TestCaseName: "Verify that the button is accessible via screen readers",
  },
  {
    TestId: "TC11",
    TestCaseName: "Verify the button's appearance on different browsers",
  },
  {
    TestId: "TC12",
    TestCaseName:
      "Verify that the button retains its state after a page refresh",
  },
  {
    TestId: "TC13",
    TestCaseName:
      "Verify that the button does not overlap with other page elements",
  },
  {
    TestId: "TC14",
    TestCaseName:
      "Verify the button's styling according to the design specifications",
  },
  {
    TestId: "TC15",
    TestCaseName: "Verify that the button loads correctly without any errors",
  },
];
